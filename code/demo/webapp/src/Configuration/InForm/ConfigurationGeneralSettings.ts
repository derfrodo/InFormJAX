...
interface FM extends InFormDataTypes<string, string> {
    ["STRING"]: InFormDataTypeWithDefaultValueAndComponent<"STRING", Scalars['String'], "", typeof StringInput>
...
export interface ConfigurationGeneralSettings extends InFormGeneralSettings<FM> {
