...
export type GameChangedSubscription = { __typename?: 'Subscription', gameChanged?: { __typename?: 'Game', isRunning: boolean, isRoundDone: boolean, canToggle: boolean, result?: { __typename?: 'WheelPart', id: string, win: boolean, name: string, winText?: string | null } | null } | null };
