...
export type WheelPart = {
  ...
  occurances: Array<Maybe<GameResult>>;
...
export type WheelSettingsQuery = { __typename?: 'Query', wheelSettings?: { __typename?: 'WheelSettings', radius: number, rotationDurationNotPlaying: number, rotationDurationPlaying: number, rotationDurationInner: number, minClickDelayMS: number, minAutoplayDurationMS: number, autoplayAddMaxMS: number } | null };
...
export type UpdateWheelSettingsMutation = { __typename?: 'Mutation', updateWheelSettings?: { __typename?: 'WheelSettings', radius: number, rotationDurationNotPlaying: number, rotationDurationPlaying: number, rotationDurationInner: number, minClickDelayMS: number, minAutoplayDurationMS: number, autoplayAddMaxMS: number } | null };
...
export type StartAutoplayMutationVariables = Exact<{ [key: string]: never; }>;


export type StartAutoplayMutation = { __typename?: 'Mutation', startAutoplay?: { __typename?: 'Game', isRunning: boolean } | null };
...
export type StatisticsQuery = { __typename?: 'Query', wheelParts?: Array<{ __typename?: 'WheelPart', id: string, name: string, resultCount: number }> | null, statistics?: { __typename?: 'Statistics', total?: number | null, won?: number | null, loose?: number | null } | null };
...
export const StartAutoplayDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"startAutoplay"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"startAutoplay"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isRunning"}}]}}]}}]} as unknown as DocumentNode<StartAutoplayMutation, StartAutoplayMutationVariables>;
